...
class _AddTaskScreenState extends State<AddTaskScreen> {
  ...
  _submit(){
    if(_formkey.currentState.validate()){
      ...
      print('$_title,$_name,$_photo,$_date,$_priority');

      Task task = Task(title: _title, name:_name,photo:_photo, date: _date, priority: _priority);
      if(widget.task == null){
        task.status = 0;
                ...
                children: <Widget>[
                  ...
                  Padding(
                    ...
                    child: TextFormField(
                      ...
                      validator: (input) =>
                      input.trim().isEmpty ? 'Please enter a director name' : null,
                  ...
                  Padding(
                    ...
                    child: DropdownButtonFormField(
                      ...
                      validator: (input) =>
                      _photo == null ? 'Please select a image level' : null,
                      onSaved: (input) => _photo = input,
                      onChanged: (value){
                        setState(() {
                          _photo = value;
                        });
